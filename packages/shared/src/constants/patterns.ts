...
const ALL_PATTERN_CATALOG: PatternDefinition[] = [
  ...
  {
    type: 'grate_pattern_1',
    dimType: 'multi',
    category: 'geometric',
    rowColMode: 'module',
    rowMultiple: 1,
    columnMultiple: 1,
    displayName: 'Grate Pattern 1',
    description: 'Industrial grate module with mirrored organic vent channels',
    previewPath: '',
    previewAssetPath: 'patterns/impress/grate pattern 1.svg',
    defaults: {
      rows: 1,
      columns: 1,
      angle: 0,
    ...
    defaultUnitWidth: 26.84,
    defaultUnitHeight: 125,
  },
  {
  ...
  },
  {
    ...
    defaultUnitWidth: 36.47,
    defaultUnitHeight: 36.47,
  },
  {
    type: 'chisel_pattern',
    dimType: 'multi',
    ...
    rowMultiple: 1,
    columnMultiple: 1,
    displayName: 'Chisel Pattern',
    description: 'Hand-chiselled textured surface module',
    previewPath: '',
    previewAssetPath: 'patterns/impress/chisel pattern.svg',
    defaults: { rows: 1, columns: 1, angle: 0, stretchers: 1, weaves: 1 },
    parameterRanges: {
      rows: { min: 1, max: 10 },
      columns: { min: 1, max: 10 },
  ...
  },
  {
    ...
    rowMultiple: 1,
    columnMultiple: 1,
    displayName: 'Fibra Pattern',
    description: 'Linear fibrous texture with vertical orientation',
    previewPath: '',
    previewAssetPath: 'patterns/impress/fibra pattern.svg',
    defaults: { rows: 1, columns: 1, angle: 0, stretchers: 1, weaves: 1 },
    parameterRanges: {
      rows: { min: 1, max: 10 },
      columns: { min: 1, max: 10 },
    ...
    defaultUnitWidth: 20.09,
    defaultUnitHeight: 230.74,
  },
  {
    type: 'matrix_pattern',
    dimType: 'multi',
    ...
    defaultUnitWidth: 47.24,
    defaultUnitHeight: 47.24,
  },
  {
    type: 'mesh_pattern',
    dimType: 'multi',
    ...
    rowMultiple: 1,
    columnMultiple: 1,
    displayName: 'Mesh Pattern',
    description: 'Interwoven mesh structure with fine detail',
    previewPath: '',
    previewAssetPath: 'patterns/impress/mesh pattern.svg',
    defaults: { rows: 1, columns: 1, angle: 0, stretchers: 1, weaves: 1 },
    parameterRanges: {
      rows: { min: 1, max: 10 },
      columns: { min: 1, max: 10 },
    ...
    defaultUnitWidth: 59.06,
    defaultUnitHeight: 78.74,
  },
  {
    type: 'raffia_pattern',
    dimType: 'multi',
    ...
    rowMultiple: 1,
    columnMultiple: 1,
    displayName: 'Raffia Pattern',
    description: 'Natural raffia-style woven texture',
    previewPath: '',
    previewAssetPath: 'patterns/impress/Raffia pattern.svg',
    defaults: { rows: 1, columns: 1, angle: 0, stretchers: 1, weaves: 1 },
    parameterRanges: {
      rows: { min: 1, max: 10 },
      columns: { min: 1, max: 10 },
    ...
    defaultUnitWidth: 51.8,
    defaultUnitHeight: 51.8,
  },
  {
