...
const ALL_PATTERN_CATALOG: PatternDefinition[] = [
  ...
  },
  {
    ...
    description: 'Classic houndstooth tessellation',
    previewPath: '',
    previewAssetPath: 'patterns/houndstooth.svg',
    defaults: { rows: 6, columns: 6, angle: 0, stretchers: 1, weaves: 1 },
    parameterRanges: {
      rows: { min: 2, max: 40 },
      columns: { min: 2, max: 40 },
  ...
  },
  {
    ...
    description: 'Hourglass-shaped repeated geometry',
    previewPath: '',
    previewAssetPath: 'patterns/hourglass.svg',
    defaults: { rows: 6, columns: 6, angle: 0, stretchers: 1, weaves: 1 },
    parameterRanges: {
      rows: { min: 2, max: 40 },
      columns: { min: 2, max: 40 },
  ...
  },
  {
    type: 'isosceles',
    category: 'geometric',
    displayName: 'Isosceles',
    description: 'Angular isosceles triangle pattern',
    previewPath: '',
    previewAssetPath: 'patterns/isosceles.svg',
    defaults: { rows: 6, columns: 6, angle: 0, stretchers: 1, weaves: 1 },
    parameterRanges: {
      rows: { min: 2, max: 30 },
      columns: { min: 2, max: 30 },
  ...
  },
  {
    ...
    defaultUnitWidth: 320,
    defaultUnitHeight: 220,
  },
  {
    type: 'octagon_square',
    category: 'geometric',
  ...
  },
  {
    ...
    category: 'geometric',
    displayName: 'Plus',
    description: 'Plus-shaped repeating geometry',
    previewPath: '',
    previewAssetPath: 'patterns/plus.svg',
    defaults: { rows: 5, columns: 5, angle: 0, stretchers: 1, weaves: 1 },
    parameterRanges: {
      rows: { min: 2, max: 20 },
      columns: { min: 2, max: 20 },
  ...
  },
  {
    ...
    category: 'organic',
    displayName: 'Rubble',
    description: 'Irregular rubble stonework',
    previewPath: '',
    previewAssetPath: 'patterns/rubble.svg',
    defaults: { rows: 5, columns: 5, angle: 0, stretchers: 1, weaves: 1 },
    parameterRanges: {
  ...
  },
  {
    ...
    description: 'Simple triangle tessellation',
    previewPath: '',
    previewAssetPath: 'patterns/triangle.svg',
    defaults: { rows: 6, columns: 6, angle: 0, stretchers: 1, weaves: 1 },
    parameterRanges: {
      rows: { min: 2, max: 30 },
      columns: { min: 2, max: 30 },
