...
export const MATERIAL_LIBRARY: MaterialDefinition[] = [
  ...
  imageMaterial({
    ...
    categoryId: 'wood',
    swatchColor: '#3a2d26',
    thumbPath: '/materials/AFRICAN WENGE.jpg',
    width: 400,
    height: 100,
    finish: 'oiled',
    toneVariation: 22,
  ...
  imageMaterial({
    ...
    categoryId: 'wood',
    swatchColor: '#6a4b33',
    thumbPath: '/materials/LOURO PRETO.jpg',
    width: 400,
    height: 100,
    finish: 'satin',
    toneVariation: 20,
  ...
  imageMaterial({
    ...
    categoryId: 'wood',
    swatchColor: '#b78658',
    thumbPath: '/materials/FLAMED BEECH.jpg',
    width: 400,
    height: 100,
    finish: 'brushed',
    toneVariation: 24,
  ...
  imageMaterial({
    ...
    categoryId: 'wood',
    swatchColor: '#c6915e',
    thumbPath: '/materials/KNOTTY PINE.jpg',
    width: 400,
    height: 100,
    finish: 'natural',
    toneVariation: 30,
