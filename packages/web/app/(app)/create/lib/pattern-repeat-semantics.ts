...
const PATTERN_SEMANTICS_OVERRIDES: Partial<Record<PatternType, Omit<PatternRepeatSemantics, 'patternType' | 'layoutSource'>>> = {
  ...
  basketweave: {
    ...
    dimensionsMeaning: 'Width and height define the base brick used by procedural basket groups.',
    semanticHint: 'Basketweave groups are generated procedurally with alternating horizontal and vertical sets using the weave count.',
    materialWidthLabel: 'Brick Width',
    materialHeightLabel: 'Brick Height',
    rowFieldLabel: 'Rows',
    columnFieldLabel: 'Columns',
